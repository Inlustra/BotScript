...
public class Script_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_udqu28_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createIndentCell_udqu28_c0(editorContext, node));
  ...
  private EditorCell createIndentCell_udqu28_c0(EditorContext editorContext, SNode node) {
    EditorCell_Indent editorCell = new EditorCell_Indent(editorContext, node);
    return editorCell;
  }
  private EditorCell createRefNode_udqu28_d0(EditorContext editorContext, SNode node) {
    SingleRoleCellProvider provider = new Script_Editor.statementListSingleRoleHandler_udqu28_d0(node, MetaAdapterFactory.getContainmentLink(0x6dab4a3ca32147f8L, 0x863d767666dd7eecL, 0x2ad15f1dd731b518L, 0x2ad15f1dd731fea8L, "statementList"), editorContext);
    return provider.createCell();
  }
  private class statementListSingleRoleHandler_udqu28_d0 extends SingleRoleCellProvider {
    public statementListSingleRoleHandler_udqu28_d0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
